...
public class HashQuadraticProbingTest {
	...
	public void should_ThrowException_WhenInitialSizeIsLowerThanOne() {
		...
		// when
		HashTable<Double> unusedHash = new HashQuadraticProbing<>(initialSize);
	...
	public void should_ThrowException_WhenPutNull() {
		// given
		HashTable<Integer> hash = new HashQuadraticProbing<>(10);
	...
	@Test(expected = IllegalArgumentException.class)
	public void should_ThrowException_WhenParameterAIsEqualToZero() {
		// given
		double a = 0;

		// when
		HashTable<Double> unusedHash = new HashQuadraticProbing<>(10, a, 2.0);
	...
	@Test(expected = IllegalArgumentException.class)
	public void should_ThrowException_WhenParameterBIsEqualToZero() {
		// given
		double b = 0;

		// when
		HashTable<Double> unusedHash = new HashQuadraticProbing<>(10, 2.0, b);
	...
	public void should_CorrectlyAddAndGet_WhenAddedManyElementsWithTheSameHashCode() {
		// given
		HashTable<Integer> hash = new HashQuadraticProbing<>(5);
		Integer elem = 8;
	...
	@Test
	public void should_Work_WhenBothParametersAreMuchBiggerThanSizeOfHash() {
		// given
		HashTable<Integer> hash = new HashQuadraticProbing<>(5, 100, 100);
		Integer elem = 8;
		Integer[] result = new Integer[100];
		Integer[] expected = new Integer[100];
